...
def createCardInSalesforce(update,user):
    try:
        ...
        update.message.reply_text('0'+str(e[0]))
        update.message.reply_text('res con'+str(e.response_content))
        update.message.reply_text('con'+str(e.content))
        update.message.reply_text('mes'+str(e.message))
        update.message.reply_text('mess'+str(e.messages))
